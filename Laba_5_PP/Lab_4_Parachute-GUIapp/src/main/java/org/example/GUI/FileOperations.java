...
public class FileOperations {
    ...
    public static void readFromFile(AbstractStorage<TransportDTO> storage, String filename) throws IOException {
    ...
    public static void writeToFile(AbstractStorage<TransportDTO> storage, String filename) {
        if (filename.endsWith(".txt")) {
